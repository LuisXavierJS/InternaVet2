...
class DoubleArrowsView: ContentView, ArrowTouchableDelegateProtocol {
    ...
    private func setupArrow(arrow: ArrowTouchableView, withAlpha alpha: CGFloat) {
        arrow._mainArrowColor = self.arrowsMainColor.withAlphaComponent(alpha)
        arrow._baseArrowColor = self.arrowsBaseColor.withAlphaComponent(alpha)
